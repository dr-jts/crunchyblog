...
[PostGIS](https://postgis.net/) excels at storing, manipulating and analyzing geospatial data.  But at some point it's usually desired to produce a two-dimensional representation to engage the integrative capabilities of the human visual cortex.  In other words, to show spatial data on a map.  
